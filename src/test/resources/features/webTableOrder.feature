...
Feature: Web table user order feature
  ...
  Scenario Outline: User should be able to place order and order seen in web table
    ...
    And user enters process order button
    Then user should see "<expectedNameOnFirstRow>" in first row of the web table

    @femaleScientist @maleScientist
    Examples:
      | productType | quantity | customerName       | street    | city   | state   | zipcode | cardType | cardNumber       | expDate | expectedNameOnFirstRow |
